...
const ListingDetails = () => {
  ...
  const getListingDetails = async() => {
    try {
      ...
      console.log("Fetch listing details failed (frontend)", error.message);
    }
  }
  ...
  const handleSubmit = async () => {
    try {
      const bookingForm = {
        customerId, listingId, hostId: listing.creator._id, startDate: dateRange[0].startDate.toDateString(), endDate: dateRange[0].endDate.toDateString(), totalPrice: listing.price * dayCount,
      };
      ...
      console.log("Submit booking failed (frontend)", error.message)
    }
  }
