...
const CreateListing = () => {
  ...
  const handleSelectAmenities = (facility) => {
    ...
    //upload, drag n drop, remove photos
    ...
    const handlePost = async(e) => {
        ...
        try {
            ...
            //append selected photos to the form data object
            ...
            console.log("Pusblish listing failed (frontend)", error.message)
        }
    }
            ...
            <form onSubmit={handlePost}>
                <div className='create-listing_step1'>
                    ...
                    <div className='half'>
                        <div className='location'>
                            ...
                            <input type='text' placeholder='Apt, Suite, etc. (if applicable)' value={formLocation.aptSuite} name='aptSuite' onChange={handleChangeLocation} required/>
                        </div>
                        <div className='location'>
                            <p>City</p>
                            <input type='text' placeholder='City' value={formLocation.city} name='city' onChange={handleChangeLocation} required/>
                        </div>
                    </div>
                    <div className='half'>
                        <div className='location'>
                    ...
                    <div className='basics'>
                        <div className='basic'>
                            ...
                            <div className='basic_count'>
                                <RemoveCircleOutline onClick={() => (guestCount > 1 && setGuestCount(guestCount - 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/><p>{guestCount}</p><AddCircleOutline onClick={() => (setGuestCount(guestCount + 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/>
                            </div>
                        </div>
                        <div className='basic'>
                            <p>Bedrooms</p>
                            <div className='basic_count'>
                                <RemoveCircleOutline onClick={() => (bedroomCount > 1 && setBedroomCount(bedroomCount - 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/><p>{bedroomCount}</p><AddCircleOutline onClick={() => (setBedroomCount(bedroomCount + 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/>
                            </div>
                        </div>
                        <div className='basic'>
                            <p>Beds</p>
                            <div className='basic_count'>
                                <RemoveCircleOutline onClick={() => (bedCount > 1 && setBedCount(bedCount - 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/><p>{bedCount}</p><AddCircleOutline onClick={() => (setBedCount(bedCount + 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/>
                            </div>
                        </div>
                        <div className='basic'>
                            <p>Bathrooms</p>
                            <div className='basic_count'>
                                <RemoveCircleOutline onClick={() => (bathroomCount > 1 && setBathroomCount(bathroomCount - 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/><p>{bathroomCount}</p><AddCircleOutline onClick={() => (setBathroomCount(bathroomCount + 1))} sx={{fontSize: "25px", cursor:"pointer", "&:hover": {color: variables.pinkred}}}/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='create-listing_step2'>
                    ...
                    <div className='description'>
                        ...
                        <p>Highlight Detials</p>
                        <textarea type='text' placeholder='Highlight Detials' name='highlightDesc' value={formDescription.highlightDesc} onChange={handleChangeDescription} required/>
